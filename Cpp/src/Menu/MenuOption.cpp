...
MenuOption::MenuOption(MusicManager* mm,SoundManager* sm,sf::Vector2i* s):Menu(s)
{
    ...
    addObs("Slider Sound",new Slider(mm,0.f, 100.f, 0, SliderSize, SliderSoundPos));
    addObs("Checkbox Sound",new Checkbox(mm,sf::Vector2f(CheckboxSoundPos.x+5,CheckboxSoundPos.y+5),CheckboxSoundPos,sf::Vector2f(10,10),sf::Vector2f(20,20))); // 1 : Position de la marque rouge   2 : Position de la checkbox
    addObs("Slider Musique",new Slider(sm,0.f, 100.f, 0, SliderSize, SliderMusicPos));
    addObs("Checkbox Musique",new Checkbox(sm,sf::Vector2f(CheckboxMusicPos.x+5,CheckboxMusicPos.y+5),CheckboxMusicPos,sf::Vector2f(10,10),sf::Vector2f(20,20))); // 1 : Position de la marque rouge   2 : Position de la checkbox
}
